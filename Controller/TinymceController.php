...
//                die($fileManagerDir . '../../../../../../../../web/files/uploads/' . $dirName . '/');
                ...
                if (strpos($file, '.php') !== false) {
                        ...
                        */
                        ...
                        $mwebConfig =  array_merge(
                                ...
                                array(
                                        'MaxSizeUpload' => ((int)(ini_get('post_max_size')) < $mwebConfig['MaxSizeUpload'])
                                                ? (int)(ini_get('post_max_size')) : $mwebConfig['MaxSizeUpload'],
                                        'ext' => array_merge(
                                                $mwebConfig['ext_img'],
                                                $mwebConfig['ext_file'],
                                                $mwebConfig['ext_misc'],
                                                $mwebConfig['ext_video'],
                                                $mwebConfig['ext_music']
                                        ),
                                        ...
                                        'aviary_defaults_config' => array(
                                                'apiKey' => $mwebConfig['aviary_apiKey'],
                                                'language' => $mwebConfig['aviary_language'],
                                                'theme' => $mwebConfig['aviary_theme'],
                                                'tools' => $mwebConfig['aviary_tools'],
                                                'maxSize' => $mwebConfig['aviary_maxSize']
                                        ),
                                )
                        );
                        ...
                        if (!$fs->exists($mwebConfig['thumbs_base_path'])) {
                                $fs->mkdir($mwebConfig['thumbs_base_path']);
                        }
